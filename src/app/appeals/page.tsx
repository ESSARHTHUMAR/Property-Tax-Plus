    ...
    return (
      <div className="px-6 space-y-4 w-full">
        <div className="flex justify-between items-center">
          <h1 className="text-sm text-[#2D2E34] font-medium pb-2 relative after:content-[''] after:absolute after:bottom-0 after:left-0 after:h-[4px] after:w-[144px] after:bg-[#3FC3AC] after:rounded-[8px]">
            Appeal Letter{" "}
